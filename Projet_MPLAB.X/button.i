#line 1 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.c"
#line 1 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.c"

#line 21 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.c"
...
#line 23 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.c"

#line 1 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.h"

#line 21 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.h"
 


#line 25 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.h"

#line 27 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.h"
#line 28 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.h"
#line 29 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.h"
#line 30 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.h"
...
#line 24 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.c"
#line 25 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.c"


#line 41 "../firmware/src/system_config/8bitwdk_pic18f46j50_24j40/button.c"
...
uint8_t BUTTON_Pressed(void)
{
    ...
    if (PORTBbits.RB0  == 0)
    {
        ...
        if(PORTBbits.RB0  == 0)
        {
            ...
            tickDifference.Val = (t.Val - switch0PressTime.Val) ;
            if(tickDifference.Val > 0x00001FFF )
                result = 1 ;
        }
        else
            result = 0 ;
    ...
    if (PORTBbits.RB2  == 0)
    {
        ...
        if(PORTBbits.RB2  == 0)
        {
            ...
            tickDifference.Val = (t.Val - switch1PressTime.Val) ;
            if(tickDifference.Val > 0x00001FFF )
                result = 2 ;
        }
        else
